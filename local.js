...
sendConvocation(
  ...
  //   prenom:prenom,
  //   nom:nom,
  //   email:"isadoravuongvan@gmail.com", // mail
  //   prerequis_fromprog:prerequis_fromprog,
  //   public_fromprog:public_fromprog,
  //   titre_fromprog:titre_fromprog,
  //   introcontexte_fromprog:marked(introcontexte_fromprog),
  //   contenu_fromprog:marked(contenu_fromprog),
  //   objectifs_fromprog:marked(objectifs_fromprog),
  //   methodespedago_fromprog:marked(methodespedago_fromprog),
  //   modaliteseval_fromprog:marked(modaliteseval_fromprog),
  //   Formateurice:Formateurice,
  //   dates:dates,
  //   sessId: sessId,
  // },
  testData,
